...
const Home = () => {
    return (
        <div>
            ...
            <section class="mainFacilitySection">`
                <span class="facilityWeHave">FACILITY WE HAVE</span>
                ...
                <div class="facilitySection">
                    <div class="facilityBox">
                        ...
                        <div class="detailsFacilityText">
                            <div>
                                <p class="facilityPara">Medical surgery</p>
                                <h2>Eye care service</h2>
                            </div>
                            <div><img class="facilityIcon" width="56px" height="56px" src="images/hospital.png"
                                alt="img OF FACILITY" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="facilityBox">
                        ...
                        <div class="detailsFacilityText">
                            <div>
                                <p class="facilityPara">Medical Therapy</p>
                                <h2>Cardiology Services</h2>
                            </div>
                            <div><img class="facilityIcon" width="56px" height="56px" src="images/therapy.png"
                                alt="img OF FACILITY" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="facilityBox">
                        ...
                        <div class="detailsFacilityText">
                            <div>
                                <p class="facilityPara">Medical Pediatrics</p>
                                <h2>Dental Services</h2>
                            </div>
                            <div><img class="facilityIcon" width="56px" height="56px" src="images/dental-service.png"
                                alt="img OF FACILITY" />
                            </div>
                        </div>
                    </div>
            ...
            <section class="mainAabouUs">
                <div class="hero-section">
                    <div class="content">
                        <div class="boxLeftOfContent">
                            ...
                            <div class="feature">
                                ...
                                <div>
                                    <h3 class="featureH3">Infection Prevention</h3>
                    ...
                    <div class="stats">
                        <div>
                            <h2 class="incrementDetails">80</h2>
                            <p>Happy Patients</p>
                        </div>
                        <div>
                            <h2 class="incrementDetails">100</h2>
                            <p>Saved Hearts</p>
                        </div>
                        <div>
                            <h2 class="incrementDetails">59</h2>
                            <p>Expert Doctors</p>
                        </div>
                    </div>
                </div>
            ...
            <section class="services-section">
                ...
                <div class="services-grid">
                    <div class="service-card remove_LEFT">
                    ...
                    <div class="service-card remove_LEFT removeBottom">
                    ...
                    <div class="service-card removeBottom">
            ...
            <section class="portfolio-section">
                <div class="portfolio-header">
                    <span class="tagline">OUR PORTFOLIO</span>
            ...
            <section class="mainOurStep">
                <span class="mainOurStepSpan">Our Step</span>
                <h1>Our Working Best Process</h1>
                <div class="outStepInFourWay">
                    <div class="boxOutStep">
                        <div class="outStepImage">
                            <img src="https://medicate.peacefulqode.co.in/wp-content/uploads/2022/03/4-1-1.png"
                                alt="imageONE" />
                        </div>
                        <div>
                            <h4 class="boxOutStepTextH4">Emergency Care</h4>
                            <p class="boxOutStepTextPara">There are many variations of passages Lorem Ipsum available</p>
                        </div>
                    ...
                    <div class="boxOutStep">
                        ...
                        <div>
                            <h4 class="boxOutStepTextH4">Operation Theatre</h4>
                            <p class="boxOutStepTextPara">There are many variations of passages Lorem Ipsum available</p>
                        </div>
                    ...
                    <div class="boxOutStep">
                        ...
                        <div>
                            <h4 class="boxOutStepTextH4">Blood Test</h4>
                            <p class="boxOutStepTextPara">There are many variations of passages Lorem Ipsum available</p>
                        </div>
                    ...
                    <div class="boxOutStep">
                        ...
                        <div>
                            <h4 class="boxOutStepTextH4">Outdoor Checkup</h4>
                            <p class="boxOutStepTextPara">There are many variations of passages Lorem Ipsum available</p>
                        </div>
                    </div>
            ...
            <section class="mainOurTeam">
                <span class="mainOurTeamSpam">Our Team</span>
                <h1>Meet Our Heart Speaclist </h1>
                <div class="outTeamMembers">
                    <div class="outTeamMemberBox">
                        <div><img width="100%" src="https://medicate.peacefulqode.co.in/wp-content/uploads/2022/02/1-2.jpg"
                            alt="" />
                        </div>
                        <div class="detailsOfDrNameQuality">
                            <h5 class="drNameOurTeam">vinay</h5>
                            <p>Neurology</p>
                        </div>
                        <div class="iconOfOurTeam w3-animate-top">
                            <div><i class="fa fa-facebook-f">f</i></div>
                            <div><i class="fa fa-google"></i>G</div>
                            <div><i class="fa fa-instagram">in</i></div>
                        </div>
                    </div>
                    ...
                    <div class="outTeamMemberBox">
                        ...
                        <div>
                            <h5 class="drNameOurTeam">Vinay's wife </h5>
                            <p>Endocrinology</p>
                        </div>
                        <div class="iconOfOurTeam w3-animate-top">
                            <div><i class="fa fa-facebook-f">f</i></div>
                    ...
                    <div class="outTeamMemberBox">
                        ...
                        <div>
                            <h5 class="drNameOurTeam">Dr. Vinay</h5>
                            <p>Eye Care</p>
                        </div>
                        <div class="iconOfOurTeam w3-animate-top">
                            <div><i class="fa fa-facebook-f">f</i></div>
            ...
            <section class="ourClient">
                ...
                <div class="ourClientMessage">
                    <div class="personalMsgFromClient">
                        ...
                        <div class="boxOFClientDetails">
                            <div class="imageandNameOFClEent">
            ...
            <section>
                <hr />
                <div class="imageFlexFIVEimage">
                    <div class="imageflexfive"><img width="100%"
            ...
            <section class="mainOurBlog">
                <span class="mainOurBlogSpan">Our Blog</span>
                <h1 class=" headOfMainOurBlog">See Our Latest Blog</h1>
                    ...
                    <div class="singleBlog">
                        <div class="singleBlogImage">
                            <img width="100%"
                                ...
                                alt="" />
                            <div class="dateTimeInOurBlog">
                                <span>December 17, 2021</span>
                            </div>
                        </div>
                        <div class="textContainerInBlog">
                            <div class="showComentOfSingleBlog">
                                <span>🤦‍♂️peacefulqube</span>
                                &ensp;
                                <span>Ⓜ️ 11 comments</span>
                            </div>
                            <hr class="singleBlogHrLine" />
                            <div class="blogTextSingle">
